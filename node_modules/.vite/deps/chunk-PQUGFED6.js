...
var _Transaction = class _Transaction2 {
  ...
  static from(transaction) {
    ...
    if (isTransaction(transaction)) {
      __privateSet4(newTransaction, _data, TransactionDataBuilder.restore(
        transaction.getData()
      ));
...
runPlugins_fn = async function(plugins, options) {
  try {
    ...
    __privateSet4(this, _availableResults, new Set(__privateGet4(this, _commandSection).map((_, i) => i)));
  }
};
...
//# sourceMappingURL=chunk-PQUGFED6.js.map
